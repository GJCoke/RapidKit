...
1. Announce: "Plan complete and saved to `docs/superpowers/plans/<filename>.md`. I’ll execute it in this session using executing-plans."
2. Invoke the `executing-plans` skill.
3. Execute the plan in the current session with its review checkpoints.

Do not offer execution choices, dispatch subagents, or wait for the user to select an execution mode.

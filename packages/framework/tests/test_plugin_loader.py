...
import pytest
from rapidkit_framework.loader import PluginLoadError, discover_and_load_plugins
from rapidkit_framework.plugin import PluginError, PluginLoadResult, PluginManifest


class TestTopologicalSort:
    def test_dependency_order(self):
        """B 依赖 A → 排序返回 [A, B]。"""
        from rapidkit_framework.loader import topological_sort
    ...
    def test_circular_dependency_raises(self):
        ...
        from rapidkit_framework.loader import PluginLoadError, topological_sort
...
class TestPluginLoadResult:
    def test_create_with_defaults(self):
        ...
        from rapidkit_framework.plugin import PluginLoadResult, PluginManifest
...
class TestDiscoverAndLoadPlugins:
    def test_discovers_from_entry_points(self, monkeypatch: pytest.MonkeyPatch):
        ...
        monkeypatch.setattr("rapidkit_framework.loader._get_entry_points", lambda: eps)
    ...
    def test_required_plugin_failure_raises(self, monkeypatch: pytest.MonkeyPatch):
        ...
        monkeypatch.setattr("rapidkit_framework.loader._get_entry_points", lambda: [ep])
    ...
    def test_non_required_plugin_failure_records_error(self, monkeypatch: pytest.MonkeyPatch):
        ...
        monkeypatch.setattr("rapidkit_framework.loader._get_entry_points", lambda: [ep_good, ep_bad])
    ...
    def test_no_entry_points_returns_empty(self, monkeypatch: pytest.MonkeyPatch):
        ...
        monkeypatch.setattr("rapidkit_framework.loader._get_entry_points", lambda: [])
...
class TestEntryPointsIntegration:
    ...
    def test_real_entry_points_discoverable(self):
        ...
        from rapidkit_framework.loader import _get_entry_points
...
class TestDependencyOverridesIntegration:
    ...
    def test_apply_overrides_to_mock_app(self):
        ...
        from rapidkit_framework.loader import apply_dependency_overrides
...
class TestMiddlewareMountingIntegration:
    ...
    def test_mount_multiple_plugins_middlewares(self):
        ...
        from rapidkit_framework.plugin import MiddlewareDef

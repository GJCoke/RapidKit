...
import pytest
from rapidkit_core.loader import (
    PluginLoadError,
...
class TestCascadingFailure:
    def test_non_required_failure_cascades_to_dependents(self, monkeypatch):
        ...
        monkeypatch.setattr("rapidkit_core.loader._get_entry_points", lambda: [a_ep, b_ep, c_ep])
    ...
    def test_load_time_tracking(self, monkeypatch):
        ...
        monkeypatch.setattr("rapidkit_core.loader._get_entry_points", lambda: [a_ep])
